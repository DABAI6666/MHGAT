...
def main():
    ...
    Parallel(n_jobs=30, backend='threading')(delayed(loadEid)(treeDic[eid] if eid in treeDic else None,eid,labelDic[eid]) for eid in tqdm(event) if not os.path.exists(os.path.join(cwd,'data/Weibograph/'+eid+'.npz')))
